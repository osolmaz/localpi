...
- Keep the palette in `src/common/catppuccin.ts` as the single source of truth. Build both the Pi theme file and localpi's own output colors from it. Do not copy hex values into other modules.
